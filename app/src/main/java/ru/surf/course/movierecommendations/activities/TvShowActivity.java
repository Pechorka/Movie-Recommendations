...
public class TvShowActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        collapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.tv_show_collapsing_toolbar_layout);
        ...
        backButton = (Button)findViewById(R.id.tv_show_back_button);
    }
    ...
    private void setupViews() {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                int offsetToToolbar = appBarLayout.getTotalScrollRange() - Utilities.getActionBarHeight(TvShowActivity.this) - fakeStatusBar.getMeasuredHeight();

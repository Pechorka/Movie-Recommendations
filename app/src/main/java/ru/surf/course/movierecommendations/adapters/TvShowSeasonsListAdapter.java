...
public class TvShowSeasonsListAdapter extends RecyclerView.Adapter<TvShowSeasonsListAdapter.MyViewHolder> {
    ...
    public TvShowSeasonsListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_item_seasons, parent, false);
    ...
    public void onBindViewHolder(TvShowSeasonsListAdapter.MyViewHolder holder, int position) {
        ...
        holder.mNumberOfEpisodes.setText(mContext.getResources().getQuantityString(R.plurals.episodes, season.getEpisodeCount(), season.getEpisodeCount()));
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            mNumberOfEpisodes = (TextView)itemView.findViewById(R.id.recycler_item_seasons_number_of_episodes);

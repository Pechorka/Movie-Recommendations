...
public class FavoritesAdapter extends
    RecyclerView.Adapter<FavoritesAdapter.FavoriteViewHolder> implements ItemTouchHelperAdapter {
  ...
  public FavoritesAdapter(Context context, List<Favorite> favoriteList, DBHelper helper) {
  ...
  public void onItemDismiss(int position) {
    Favorite favorite = favoriteList.remove(position);
    notifyDataSetChanged();
    helper.deleteFavorite(favorite);
  }

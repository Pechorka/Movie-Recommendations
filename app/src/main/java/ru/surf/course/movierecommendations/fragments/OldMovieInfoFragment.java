...
public class OldMovieInfoFragment extends Fragment implements GetMoviesTask.TaskCompletedListener {
    ...
    public static OldMovieInfoFragment newInstance(MovieInfo movieInfo) {
        OldMovieInfoFragment oldMovieInfoFragment = new OldMovieInfoFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(KEY_MOVIE, movieInfo);
        oldMovieInfoFragment.setArguments(bundle);
        return oldMovieInfoFragment;
    }

    public static OldMovieInfoFragment newInstance(int movieId) {
        OldMovieInfoFragment oldMovieInfoFragment = new OldMovieInfoFragment();
        Bundle bundle = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_old_movie_info, container, false);
        initViews(root);

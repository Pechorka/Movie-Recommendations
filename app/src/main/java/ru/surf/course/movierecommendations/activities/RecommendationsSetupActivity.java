...
import ru.surf.course.movierecommendations.adapters.RecommendationsSetupListAdapter;
...
import ru.surf.course.movierecommendations.tmdbTasks.GetListTask;

public class RecommendationsSetupActivity extends AppCompatActivity implements Callback<RecommendationsSetupActivity.RetrofitResult> {

    private final static String TAG = RecommendationsSetupActivity.class.getSimpleName();
        ...
        switch (item.getItemId()) {
            case R.id.recommendations_setup_menu_save:
                if (movie) {
                    ...
                    saveGenresIds();
                    SharedPreferences prefs = getSharedPreferences(SplachActivity.KEY_RECOMMENDATIONS_SETUP, MODE_PRIVATE);
    ...
    @Override
    public void onResponse(Call<RecommendationsSetupActivity.RetrofitResult> call, Response<RecommendationsSetupActivity.RetrofitResult> response) {
    ...
    private void setupToolbar() {
        ...
        getSupportActionBar().setTitle("Choose movies you like");
    }
